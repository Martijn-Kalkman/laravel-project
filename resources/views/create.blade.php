...
<div class="container w-3/12  mx-auto p-4 rounded-lg">
    <form method="POST" action="{{ route('animelist.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <textarea required name="description" id="description" class="w-full p-2 rounded-lg bg-white text-black focus:ring-2 focus:ring-blue-500 focus:outline-none"></textarea>
        </div>
